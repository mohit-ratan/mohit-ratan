...
export default function LandingPage() {
  return <div className="intro-page">
    ...
    <header className="intro-nav">
      ...
      <nav aria-label="Public navigation"><a className="intro-how-link" href="#how-it-works">How it works</a><Link className="intro-how-link" to="/awards">Awards gallery</Link><Link to="/login">Sign in</Link><Link className="intro-button intro-button-small" to="/register">Get started <span aria-hidden="true">↗</span></Link></nav>
    </header>
    <main id="intro-main">
