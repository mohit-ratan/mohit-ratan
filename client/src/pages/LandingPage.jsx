...
export default function LandingPage() {
  return <div className="intro-page">
    ...
    </main><footer className="intro-footer"><Link className="intro-brand" to="/"><BrandLogo size={25} /><span>PackSomeWork</span></Link><p>A little progress, every day.</p><Link to="/login">Sign in <span aria-hidden="true">↗</span></Link></footer>
  </div>;
}
